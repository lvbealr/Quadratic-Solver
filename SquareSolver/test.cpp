...
bool coefficientInput(char coefficientName, double *coefficient) {
    char coefficient_str[100] = ""; // TODO make const size_t INPUT_STRING_SIZE = 100;

    for (int iter = 0; iter < 3; iter++) {
        printf("Input valid value of coefficient %c:", coefficientName);
        gets(coefficient_str); // TODO scanf with 100 chars limit
...
int main() {
    ...
    rootListDestruct(&roots); // TODO test and manual modes
    /*/ END USER INPUT /*/
//    runAllTests();
